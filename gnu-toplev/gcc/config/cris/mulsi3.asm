...
;; Not worthwhile to conditionalize that part here, except we use a
;; slightly different instruction as "nop".
	...
	jump $r9
	setf
#elif defined (__CRIS_arch_version) && __CRIS_arch_version >= 10
	.p2alignw 2,0x050f
	mulu.d $r11,$r10
	ret
	nop
