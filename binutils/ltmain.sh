...
# HACK: To build all tools in a toolchain statically, I want to be
# able to say 'CC=gcc -static', or at least use a configure
# flag.  Until such a flag is available, I use this hack that makes
# -static equivalent to -all-static.  See -all-static case above.
#
#      -static)
