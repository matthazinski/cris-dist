...
static void s_cris_errwarn PARAMS ((int));
...
/* The meat of md_long_jump_size.  This is usually a constant, not a
   function, so we'll get some compilation warnings wherever the
   prototype is used.  */

const int
cris_long_jump_size ()
{
  return cris_arch == arch_crisv32 ? 8 : 6;
}
