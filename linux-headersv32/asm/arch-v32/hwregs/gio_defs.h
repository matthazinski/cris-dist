 ...
 *      id: $Id: gio_defs.h,v 1.5 2004/06/04 07:15:33 starvik Exp $
...
} reg_gio_rw_pa_data_out;
#define REG_RD_ADDR_gio_rw_pa_data_out 0
#define REG_WR_ADDR_gio_rw_pa_data_out 0

/* Register r_pa_data_in, scope gio, type r */
typedef struct {
  unsigned int data : 8;
  unsigned int dummy1 : 24;
} reg_gio_r_pa_data_in;
#define REG_RD_ADDR_gio_r_pa_data_in 4
...
} reg_gio_rw_pb_data_out;
#define REG_RD_ADDR_gio_rw_pb_data_out 32
#define REG_WR_ADDR_gio_rw_pb_data_out 32

/* Register r_pb_data_in, scope gio, type r */
typedef struct {
  unsigned int data : 18;
  unsigned int dummy1 : 14;
} reg_gio_r_pb_data_in;
#define REG_RD_ADDR_gio_r_pb_data_in 36
...
typedef struct {
  unsigned int data : 18;
  unsigned int dummy1 : 14;
} reg_gio_rw_pc_data_out;
#define REG_RD_ADDR_gio_rw_pc_data_out 48
#define REG_WR_ADDR_gio_rw_pc_data_out 48

/* Register r_pc_data_in, scope gio, type r */
typedef struct {
  unsigned int data : 18;
  unsigned int dummy1 : 14;
} reg_gio_r_pc_data_in;
#define REG_RD_ADDR_gio_r_pc_data_in 52
...
typedef struct {
  unsigned int data : 18;
  unsigned int dummy1 : 14;
} reg_gio_rw_pd_data_out;
#define REG_RD_ADDR_gio_rw_pd_data_out 64
#define REG_WR_ADDR_gio_rw_pd_data_out 64

/* Register r_pd_data_in, scope gio, type r */
typedef struct {
  unsigned int data : 18;
  unsigned int dummy1 : 14;
} reg_gio_r_pd_data_in;
#define REG_RD_ADDR_gio_r_pd_data_in 68
...
typedef struct {
  unsigned int data : 18;
  unsigned int dummy1 : 14;
} reg_gio_rw_pe_data_out;
#define REG_RD_ADDR_gio_rw_pe_data_out 80
#define REG_WR_ADDR_gio_rw_pe_data_out 80

/* Register r_pe_data_in, scope gio, type r */
typedef struct {
  unsigned int data : 18;
  unsigned int dummy1 : 14;
} reg_gio_r_pe_data_in;
#define REG_RD_ADDR_gio_r_pe_data_in 84
