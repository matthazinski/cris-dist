 ...
 *     id:           eth_regs.r,v 1.9 2004/03/12 10:41:36 kriskn Exp 
 *     last modfied: Tue Mar 30 22:26:00 2004
 * 
 *   by /n/asic/design/tools/rdesc/src/rdes2c --outfile eth_defs.h ../../inst/eth/rtl/eth_regs.r
 *      id: $Id: eth_defs.h,v 1.5 2004/06/04 07:15:33 starvik Exp $
...
/* Register rw_clr_error, scope eth, type rw */
typedef struct {
  unsigned int clr : 1;
  unsigned int dummy1 : 31;
} reg_eth_rw_clr_error;
#define REG_RD_ADDR_eth_rw_clr_error 36
#define REG_WR_ADDR_eth_rw_clr_error 36
...
/* Register r_status, scope eth, type r */
typedef struct {
  unsigned int mdio     : 1;
...
#define REG_RD_ADDR_eth_r_status 44

/* Register rs_rec_cnt, scope eth, type rs */
typedef struct {
  unsigned int crc_error   : 8;
  unsigned int align_error : 8;
...
enum {
  ...
  regk_eth_do                              = 0x00000001,
  regk_eth_dont                            = 0x00000000,
  regk_eth_ether                           = 0x00000000,
  regk_eth_full                            = 0x00000001,
  regk_eth_half                            = 0x00000000,
  regk_eth_handsh                          = 0x00000001,
  regk_eth_mii                             = 0x00000000,
  regk_eth_mii_clk                         = 0x00000001,
  regk_eth_mii_rec                         = 0x00000002,
  regk_eth_no                              = 0x00000000,
  regk_eth_off                             = 0x00000000,
  regk_eth_on                              = 0x00000001,
  regk_eth_receive                         = 0x00000001,
  regk_eth_rw_ga_hi_default                = 0x00000000,
  regk_eth_rw_ga_lo_default                = 0x00000000,
  regk_eth_rw_gen_ctrl_default             = 0x00000020,
