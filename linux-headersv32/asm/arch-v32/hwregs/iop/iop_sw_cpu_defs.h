 ...
 *      id: $Id: iop_sw_cpu_defs.h,v 1.3 2004/05/07 12:54:31 larsv Exp $
...
typedef struct {
  ...
  unsigned int fifo_in0_xtra  : 1;
  unsigned int fifo_out0_xtra : 1;
...
typedef struct {
  ...
  unsigned int fifo_in1_xtra  : 1;
  unsigned int fifo_out1_xtra : 1;
  unsigned int trigger_grp0   : 1;
  unsigned int trigger_grp1   : 1;
  unsigned int trigger_grp2   : 1;
  unsigned int trigger_grp3   : 1;
...
enum {
  ...
  regk_iop_sw_cpu_off                      = 0x00000000,
  regk_iop_sw_cpu_on                       = 0x00000001,
