 ...
 *      id: $Id: iop_spu_defs.h,v 1.4 2004/05/07 12:54:31 larsv Exp $
...
typedef unsigned int reg_iop_spu_rw_event_value;
#define REG_RD_ADDR_iop_spu_rw_event_value 176
#define REG_WR_ADDR_iop_spu_rw_event_value 176

/* Register rw_event_return, scope iop_spu, type rw */
typedef struct {
  unsigned int addr : 12;
  unsigned int dummy1 : 20;
} reg_iop_spu_rw_event_return;
#define REG_RD_ADDR_iop_spu_rw_event_return 192
#define REG_WR_ADDR_iop_spu_rw_event_return 192
...
} reg_iop_spu_rw_breakpoint;
#define REG_RD_ADDR_iop_spu_rw_breakpoint 204
#define REG_WR_ADDR_iop_spu_rw_breakpoint 204
...
enum {
  ...
  regk_iop_spu_rw_breakpoint_default       = 0x00000000,
  regk_iop_spu_rw_breakpoint_size          = 0x00000004,
  ...
  regk_iop_spu_rw_event_value_size         = 0x00000004,
