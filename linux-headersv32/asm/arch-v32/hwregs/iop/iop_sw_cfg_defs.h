 ...
 *      id: $Id: iop_sw_cfg_defs.h,v 1.3 2004/05/07 12:54:31 larsv Exp $
...
typedef struct {
  unsigned int cfg : 2;
  unsigned int dummy1 : 30;
} reg_iop_sw_cfg_rw_fifo_in0_xtra_owner;
#define REG_RD_ADDR_iop_sw_cfg_rw_fifo_in0_xtra_owner 28
#define REG_WR_ADDR_iop_sw_cfg_rw_fifo_in0_xtra_owner 28
...
typedef struct {
  unsigned int cfg : 2;
  unsigned int dummy1 : 30;
} reg_iop_sw_cfg_rw_fifo_in1_xtra_owner;
#define REG_RD_ADDR_iop_sw_cfg_rw_fifo_in1_xtra_owner 36
#define REG_WR_ADDR_iop_sw_cfg_rw_fifo_in1_xtra_owner 36
...
typedef struct {
  unsigned int cfg : 2;
  unsigned int dummy1 : 30;
} reg_iop_sw_cfg_rw_fifo_out0_xtra_owner;
#define REG_RD_ADDR_iop_sw_cfg_rw_fifo_out0_xtra_owner 44
#define REG_WR_ADDR_iop_sw_cfg_rw_fifo_out0_xtra_owner 44
...
typedef struct {
  unsigned int cfg : 2;
  unsigned int dummy1 : 30;
} reg_iop_sw_cfg_rw_fifo_out1_xtra_owner;
#define REG_RD_ADDR_iop_sw_cfg_rw_fifo_out1_xtra_owner 52
#define REG_WR_ADDR_iop_sw_cfg_rw_fifo_out1_xtra_owner 52
...
enum {
  ...
  regk_iop_sw_cfg_bus0_rotate16            = 0x00000004,
  regk_iop_sw_cfg_bus0_rotate24            = 0x00000006,
  regk_iop_sw_cfg_bus0_rotate8             = 0x00000002,
  regk_iop_sw_cfg_bus1                     = 0x00000001,
  regk_iop_sw_cfg_bus1_rotate16            = 0x00000005,
  regk_iop_sw_cfg_bus1_rotate24            = 0x00000007,
  regk_iop_sw_cfg_bus1_rotate8             = 0x00000003,
  regk_iop_sw_cfg_clk_12                   = 0x00000000,
  ...
  regk_iop_sw_cfg_pdp_out0_hi_rotate8      = 0x00000005,
  regk_iop_sw_cfg_pdp_out0_lo              = 0x00000000,
  regk_iop_sw_cfg_pdp_out0_lo_rotate8      = 0x00000004,
  regk_iop_sw_cfg_pdp_out1                 = 0x00000003,
  regk_iop_sw_cfg_pdp_out1_hi              = 0x00000003,
  regk_iop_sw_cfg_pdp_out1_hi_rotate8      = 0x00000005,
  regk_iop_sw_cfg_pdp_out1_lo              = 0x00000002,
  regk_iop_sw_cfg_pdp_out1_lo_rotate8      = 0x00000004,
  ...
  regk_iop_sw_cfg_rw_fifo_in0_xtra_owner_default = 0x00000000,
  regk_iop_sw_cfg_rw_fifo_in1_owner_default = 0x00000000,
  regk_iop_sw_cfg_rw_fifo_in1_xtra_owner_default = 0x00000000,
  regk_iop_sw_cfg_rw_fifo_out0_owner_default = 0x00000000,
  regk_iop_sw_cfg_rw_fifo_out0_xtra_owner_default = 0x00000000,
  regk_iop_sw_cfg_rw_fifo_out1_owner_default = 0x00000000,
  regk_iop_sw_cfg_rw_fifo_out1_xtra_owner_default = 0x00000000,
  ...
  regk_iop_sw_cfg_size_16                  = 0x00000002,
  regk_iop_sw_cfg_size_24                  = 0x00000003,
  regk_iop_sw_cfg_size_32                  = 0x00000004,
  regk_iop_sw_cfg_size_8                   = 0x00000001,
