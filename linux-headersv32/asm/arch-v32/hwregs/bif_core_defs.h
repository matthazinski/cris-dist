 ...
 *      id: $Id: bif_core_defs.h,v 1.2 2004/06/04 07:15:33 starvik Exp $
...
} reg_bif_core_rs_sdram_ref_status;
#define REG_RD_ADDR_bif_core_rs_sdram_ref_status 32

/* Register r_sdram_ref_status, scope bif_core, type r */
typedef struct {
  unsigned int ok : 1;
  unsigned int dummy1 : 31;
} reg_bif_core_r_sdram_ref_status;
#define REG_RD_ADDR_bif_core_r_sdram_ref_status 36


/* Constants */
enum {
  regk_bif_core_b16                        = 0x00000001,
  regk_bif_core_b32                        = 0x00000000,
  ...
  regk_bif_core_r_sdram_ref_status_default = 0x00000001,
  regk_bif_core_rd                         = 0x00000002,
  regk_bif_core_ref                        = 0x00000001,
  regk_bif_core_rs_sdram_ref_status_default = 0x00000001,
