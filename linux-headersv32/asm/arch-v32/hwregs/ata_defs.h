 ...
 *     id:           ata_regs.r,v 1.9 2004/01/20 15:25:17 kriskn Exp 
 *     last modfied: Tue Mar 30 22:25:15 2004
 * 
 *   by /n/asic/design/tools/rdesc/src/rdes2c --outfile ata_defs.h ../../inst/ata/rtl/ata_regs.r
 *      id: $Id: ata_defs.h,v 1.6 2004/06/04 07:15:33 starvik Exp $
...
typedef struct {
  ...
  unsigned int pio_strobe : 6;
  unsigned int pio_setup  : 6;
  unsigned int dma_hold   : 6;
  unsigned int dma_strobe : 6;
  unsigned int rst        : 1;
  unsigned int en         : 1;
} reg_ata_rw_ctrl0;
...
/* Register rs_status_data, scope ata, type rs */
typedef struct {
  unsigned int data : 16;
  unsigned int dav  : 1;
  unsigned int busy : 1;
  unsigned int dummy1 : 14;
} reg_ata_rs_status_data;
#define REG_RD_ADDR_ata_rs_status_data 4

/* Register r_status_data, scope ata, type r */
typedef struct {
  unsigned int data : 16;
  unsigned int dav  : 1;
  unsigned int busy : 1;
  unsigned int dummy1 : 14;
} reg_ata_r_status_data;
#define REG_RD_ADDR_ata_r_status_data 8

/* Register rw_transfer_cnt, scope ata, type rw */
typedef struct {
  unsigned int cnt : 17;
  unsigned int dummy1 : 15;
} reg_ata_rw_transfer_cnt;
#define REG_RD_ADDR_ata_rw_transfer_cnt 20
#define REG_WR_ADDR_ata_rw_transfer_cnt 20

/* Register r_status_misc, scope ata, type r */
typedef struct {
  unsigned int crc : 16;
  unsigned int dummy1 : 16;
} reg_ata_r_status_misc;
#define REG_RD_ADDR_ata_r_status_misc 24
...
enum {
  ...
  regk_ata_off                             = 0x00000000,
  regk_ata_on                              = 0x00000001,
  regk_ata_pio                             = 0x00000000,
  regk_ata_read                            = 0x00000001,
  regk_ata_register                        = 0x00000000,
