 ...
 *     id:           sser_regs.r,v 1.17 2004/03/19 15:51:43 gunnard Exp 
 *     last modfied: Tue Mar 30 22:28:10 2004
 * 
 *   by /n/asic/design/tools/rdesc/src/rdes2c --outfile sser_defs.h ../../inst/syncser/rtl/sser_regs.r
 *      id: $Id: sser_defs.h,v 1.2 2004/06/04 07:15:33 starvik Exp $
...
/* Register rw_frame_cfg, scope sser, type rw */
typedef struct {
  ...
  unsigned int dummy1         : 1;
} reg_sser_rw_frame_cfg;
#define REG_RD_ADDR_sser_rw_frame_cfg 4
#define REG_WR_ADDR_sser_rw_frame_cfg 4
...
typedef struct {
  ...
  unsigned int shift_dir      : 1;
  unsigned int clk_pol        : 1;
  unsigned int clk_src        : 1;
  unsigned int use_dma        : 1;
  unsigned int mode           : 2;
  unsigned int frame_source   : 1;
...
enum {
  ...
  regk_sser_transmitter                    = 0x00000001,
