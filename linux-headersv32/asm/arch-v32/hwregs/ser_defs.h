 ...
 *     id:           ser_regs.r,v 1.18 2004/01/09 09:22:14 kriskn Exp 
 *     last modfied: Tue Mar 30 22:27:41 2004
 * 
 *   by /n/asic/design/tools/rdesc/src/rdes2c --outfile ser_defs.h ../../inst/ser/rtl/ser_regs.r
 *      id: $Id: ser_defs.h,v 1.9 2004/06/04 07:15:33 starvik Exp $
...
/* Register rw_data_out, scope ser, type rw */
typedef struct {
  unsigned int data : 8;
  unsigned int dummy1 : 24;
} reg_ser_rw_data_out;
#define REG_RD_ADDR_ser_rw_data_out 28
#define REG_WR_ADDR_ser_rw_data_out 28

/* Register rs_status_data, scope ser, type rs */
typedef struct {
  unsigned int data        : 8;
  ...
  unsigned int tr_ready    : 1;
  unsigned int cts_n       : 1;
  unsigned int xoff_detect : 1;
  unsigned int rts_n       : 1;
  unsigned int txd         : 1;
  unsigned int dummy2      : 3;
} reg_ser_rs_status_data;
#define REG_RD_ADDR_ser_rs_status_data 32

/* Register r_status_data, scope ser, type r */
typedef struct {
  unsigned int data        : 8;
  unsigned int dummy1      : 8;
  unsigned int data_avail  : 1;
  ...
  unsigned int txd         : 1;
  unsigned int dummy2      : 3;
} reg_ser_r_status_data;
#define REG_RD_ADDR_ser_r_status_data 36
...
enum {
  ...
  regk_ser_bits_7                          = 0x00000001,
  regk_ser_bits_8                          = 0x00000000,
  ...
  regk_ser_on                              = 0x00000001,
  regk_ser_one_bit                         = 0x00000000,
