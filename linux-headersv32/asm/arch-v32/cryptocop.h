...
/*
 * Return 0 if job removed, -1 otherwise.  Note that the job may complete
 * and its callback called while this function executes.  The caller must
 * handle this case.
 */
int cryptocop_remove_job(struct cryptocop_operation *operation);
